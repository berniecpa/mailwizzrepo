...
if (!empty($viewCollection) && $viewCollection->itemAt('renderContent')) {
    $controller->renderPartial('_tabs');
    /**
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo $controller->t('{service} is a email validation service that helps detecting bad email addresses.', ['{service}' => '<a href="https://emaailable.com" target="_blank">Emailable</a>']); ?><br />
