...
/**
 * SurveyFieldBuilderTypeStateResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeState $owner
 */
class SurveyFieldBuilderTypeStateResponder extends SurveyFieldBuilderTypeResponder
{
    /**
    ...
    public function _setCorrectValidationRules(CModelEvent $event)
    {
        ...
        $rules->add(['value', 'length', 'min' => 1, 'max' => 250]);
    }
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_state_responder_build_field_array', [
