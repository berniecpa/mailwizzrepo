...
/**
 * SurveyFieldBuilderTypeDateResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeDate $owner
 */
class SurveyFieldBuilderTypeDateResponder extends SurveyFieldBuilderTypeResponder
{
    /**
    ...
    public function _setCorrectValidationRules(CModelEvent $event)
    {
        ...
        $rules->add(['value', 'length', 'is' => 10]);
        $rules->add(['value', 'date', 'format'=>'yyyy-MM-dd']);
    }
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_date_responder_build_field_array', [
