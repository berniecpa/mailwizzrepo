...
/**
 * SurveyFieldBuilderTypeTextareaResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeTextarea $owner
 */
class SurveyFieldBuilderTypeTextareaResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_textarea_responder_build_field_array', [
