...
/**
 * SurveyFieldBuilderTypeDatetimeResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeDatetime $owner
 */
class SurveyFieldBuilderTypeDatetimeResponder extends SurveyFieldBuilderTypeResponder
{
    /**
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_datetime_responder_build_field_array', [
