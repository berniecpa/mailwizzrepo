...
/**
 * SurveyFieldBuilderTypeCheckboxlistResponder
 *
 ...
 */
class SurveyFieldBuilderTypeCheckboxlistResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    protected function buildFieldArrayMultiValues(array $models): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_checkboxlist_responder_build_field_array', [
