...
/**
 * SurveyFieldBuilderTypeUrlResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeUrl $owner
 */
class SurveyFieldBuilderTypeUrlResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    public function _setCorrectValidationRules(CModelEvent $event)
    {
        ...
        $rules->add(['value', 'url']);
        $rules->add(['value', 'length', 'min' => 7, 'max' => 250]);
    }
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_url_responder_build_field_array', [
