...
/**
 * SurveyFieldBuilderTypeCheckboxResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeCheckbox $owner
 */
class SurveyFieldBuilderTypeCheckboxResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    protected function getValueModels(): array
    {
        ...
        /** @var SurveyFieldCheckbox[] $models */
        $models = SurveyFieldCheckbox::model()->findAllByAttributes([
        ...
        foreach ($models as $model) {
            ...
            $defaultValue = strlen(trim((string)$valueModel->value)) == 0 ? SurveyFieldCheckbox::parseDefaultValueTags((string)$model->default_value, $responder) : $valueModel->value;
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_checkbox_responder_build_field_array', [
