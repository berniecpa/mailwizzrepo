...
/**
 * SurveyFieldBuilderTypeConsentCheckboxResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeConsentCheckbox $owner
 */
class SurveyFieldBuilderTypeConsentCheckboxResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    protected function getValueModels(): array
    {
        ...
        $models = SurveyFieldConsentCheckbox::model()->findAllByAttributes([
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_consent_checkbox_responder_build_field_array', [
