...
/**
 * SurveyFieldBuilderTypeEmailResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeEmail $owner
 */
class SurveyFieldBuilderTypeEmailResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    public function _setCorrectValidationRules(CModelEvent $event)
    {
        ...
        $rules->add(['value', 'email', 'validateIDN' => true]);
        $rules->add(['value', 'length', 'min' => 3, 'max' => 150]);
    }
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_email_responder_build_field_array', [
