...
/**
 * SurveyFieldBuilderTypeDropdownResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeDropdown $owner
 */
class SurveyFieldBuilderTypeDropdownResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_dropdown_responder_build_field_array', [
