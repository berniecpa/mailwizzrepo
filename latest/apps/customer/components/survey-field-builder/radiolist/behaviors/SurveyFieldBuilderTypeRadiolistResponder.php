...
/**
 * SurveyFieldBuilderTypeRadiolistResponder
 *
...
/**
 * @property SurveyFieldBuilderTypeRadiolist $owner
 */
class SurveyFieldBuilderTypeRadiolistResponder extends SurveyFieldBuilderTypeResponder
{
    /**
     * @param CEvent $event
     *
    ...
    protected function getValueModels(): array
    {
        ...
        foreach ($models as $model) {
            ...
            $defaultValue = strlen(trim((string)$valueModel->value)) == 0 ? SurveyField::parseDefaultValueTags((string)$model->default_value, $responder) : $valueModel->value;
    ...
    protected function buildFieldArray(SurveyFieldValue $model): array
    {
        ...
        return hooks()->applyFilters('survey_field_builder_type_radiolist_responder_build_field_array', [
