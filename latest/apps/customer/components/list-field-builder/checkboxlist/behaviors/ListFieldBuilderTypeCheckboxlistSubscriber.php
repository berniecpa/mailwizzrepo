...
/**
 * ListFieldBuilderTypeCheckboxlistSubscriber
 *
...
/**
 * @property ListFieldBuilderTypeCheckboxlist $owner
 */
class ListFieldBuilderTypeCheckboxlistSubscriber extends ListFieldBuilderTypeSubscriber
{
    /**
     * @param CEvent $event
     *
     ...
     * @return array
     */
    protected function buildFieldArrayMultiValues(array $models)
    {
        if (empty($models)) {
            return [
                'sort_order' => -100,
        ...
        return hooks()->applyFilters('list_field_builder_type_checkboxlist_subscriber_build_field_array', [
